...
extern void __fastcall__ SYSTEM_STRCOPY (CHAR *to, CHAR *from);
extern void __fastcall__ SYSTEM_STRAPND (CHAR *from, CHAR *to);
extern SHORTINT __fastcall__ SYSTEM_STRLEN (CHAR *str);
...
#define SYSTEM_FINI()
extern void __fastcall__ SYSTEM_HALT_m1 (BYTE n);
